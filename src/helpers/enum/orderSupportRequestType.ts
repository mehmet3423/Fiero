...
export const getOrderSupportRequestTypeTitle = (type: OrderSupportRequestType): string => {
    switch (type) {
...
export const getAllOrderSupportRequestTypes = (): { value: OrderSupportRequestType; title: string }[] => {
    return [
        { value: OrderSupportRequestType.OrderNotReceived, title: "Sipariş Teslim Alınmadı" },
        { value: OrderSupportRequestType.DamagedProduct, title: "Hasarlı Ürün" },
        { value: OrderSupportRequestType.WrongItemDelivered, title: "Yanlış Ürün Gönderimi" },
        ...
        { value: OrderSupportRequestType.OrderCancellation, title: "Sipariş İptali" },
        { value: OrderSupportRequestType.DeliveryDelayInquiry, title: "Teslimat Gecikmesi" },
