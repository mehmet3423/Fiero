...
export const CONTENT_CUSTOMIZATION_SETTINGS: Record<GeneralContentType, IsCustomizable> = {
...
export const isContentTypeCustomizable = (contentType: GeneralContentType): boolean => {
...
export const getGeneralContentTypeName = (contentType: GeneralContentType): string => {
    switch (contentType) {
