...
export default function GeneralSupportTicketsTab() {
  ...
  const [supportTicketStatus, setSupportTicketStatus] = useState<
    number | undefined
  >(
    query.supportTicketStatus !== undefined
      ? Number(query.supportTicketStatus)
      : undefined
  );
  ...
  const handleResetFilters = () => {
    ...
    setSupportTicketStatus(undefined);
    setTitle(undefined);
    setSearchTitle("");
    setFrom(undefined);
    setDisplayPage(1);
        ...
        <div className="card-header py-2">
          <div className="d-flex justify-content-between align-items-center">
            <span className="fw-semibold m-3 small">
              Genel Destek Talepleri ({totalCount})
            </span>
          </div>
        </div>
        ...
        <div className="card-body">
          {isLoading ? (
            ...
            <div className="text-center py-4">
              ...
              <p className="mt-2 text-muted">Henüz destek talebi bulunmuyor.</p>
            </div>
          ) : (
            <>
