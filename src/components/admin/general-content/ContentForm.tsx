...
import { GeneralContentType, isContentTypeCustomizable } from '@/constants/models/GeneralContent';
...
export default function ContentForm({
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (
            selectedContentType === GeneralContentType.MainProductList
        ) {
        ...
        // Görsel yüklü değilse veya yükleniyorsa engelle
        if (!imageUrl) {
        ...
        return (
            ...
            >
                <div className="d-flex justify-content-between align-items-center mb-4">
                    <h4 className="mb-0">{editingContent ? 'İçerik Düzenle' : 'Yeni İçerik Ekle'}</h4>
                    {onCancel && (
                        <button
                            type="button"
                ...
                >
                    {isLoading ? (
                        ...
                        <>
                            <i className={`fas fa-${editingContent ? 'save' : 'plus'} mr-2`}></i>
        ...
        >
            ...
            <div className="form-group mb-4">
                ...
                {(!imageUrl && editingContent?.imageUrl) && (
                    <div className="mt-2">
                        <img src={editingContent.imageUrl} alt="Mevcut görsel" style={{ maxWidth: 200, maxHeight: 120, borderRadius: 8 }} />
                        <div className="text-muted" style={{ fontSize: 12 }}>Mevcut görsel</div>
                    </div>
                )}
                {imageUrl && (
                    <div className="mt-2">
                        <img src={imageUrl} alt="Yüklenen görsel" style={{ maxWidth: 200, maxHeight: 120, borderRadius: 8 }} />
                    </div>
                )}
            </div>
