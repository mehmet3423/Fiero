...
export const useUpdateSpecialDayDiscount = () => {
  ...
  const updateDiscount = async (data: SpecialDayDiscount) => {
    ...
    await mutateAsync(
      {
        url: UPDATE_SPECIAL_DAY_DISCOUNT,
