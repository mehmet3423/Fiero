    ...
    <div style={{ width: '100%', maxWidth: 'none', border: 'none', boxShadow: 'none' }}>
      <div className={styles["flatpage-content"]} style={{ border: 'none', boxShadow: 'none' }}>
        <div className={`${styles["flatpage-text"]} ${styles["flatpage-text--link"]}`} style={{ border: 'none', boxShadow: 'none' }}>
          ...
          <p>Lorem ipsum dolor sit amet, taslak içerik buraya gelecek.</p>
          <p>
            <img src="/assets/site/images/collections/collection-69.jpg" alt="DESA Company" style={{ boxShadow: 'none', border: 'none', borderRadius: 0 }} />
          </p>
          <p>Rasgele metin: 9876543210 abcdefghıjklmn!</p>
          <p>Bu alan geçici olarak doldurulmuştur.</p>
          <p>Örnek yazı: test, deneme, içerik, taslak.</p>
        </div>
      </div>
    </div>
  );
