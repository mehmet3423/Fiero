  ...
  return (
    <AboutDesaTrLayout>
      <div className={`${styles["flatpage-text"]} ${styles["flatpage-text--link"]}`}>
        <h2>Yatırımcı Sunumları (Taslak)</h2>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Bu sayfa taslak olarak hazırlanmıştır.</p>
        <p>Yatırımcı sunumları yakında burada yer alacaktır.</p>
        <ul>
          <li>2025 Yatırımcı Sunumu - Hazırlanıyor</li>
          <li>2024 Yatırımcı Sunumu - Taslak</li>
        </ul>
