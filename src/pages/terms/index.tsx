...
export default function TermsPage() {
  const { contents, isLoading } = useGeneralContents(
    GeneralContentType.MembershipAndUsageTerms
  );
    ...
    <>
      <div className="tf-page-title style-2">
        <div className="container-full">
          <div className="heading text-center">Üyelik ve Kullanım Şartları</div>
        </div>
      </div>
          ...
          <div className="tf-main-area-page">
            <div className="flatpage__content">
              <div className="flatpage__header">
                <div className="flatpage__title flatpage__title--noimg">Üyelik ve Kullanım Şartları</div>
                <img className="lazyload flatpage__img" src="" alt="Üyelik ve Kullanım Şartları" style={{ display: "none" }} />
              </div>
      ...
      <style jsx>{`
        ...
        .flatpage__text p { margin-bottom: 0.7rem; }
        .gc-block + .gc-block { margin-top: 1rem; }
        .gc-content :global(p) { margin: 0 0 0.7rem 0; }
      `}</style>
    </>
  );
}