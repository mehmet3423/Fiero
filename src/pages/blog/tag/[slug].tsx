...
const TagPage: React.FC = () => {
  ...
  // Etiket slug'ına göre blog gönderilerini filtrele (örnek olarak)
  // Gerçek uygulamada, gönderilerin etiketleri de olmalıdır
  const filteredPosts = blogPosts.filter((_, index) => index % 2 === 0); // Örnek filtreleme
            ...
            <div className="col-lg-9">
              {filteredPosts.length > 0 ? (
                ...
                <div className="text-center py-5">
                  <h3>Bu etikete ait yazı bulunamadı.</h3>
                  <p>
                    Lütfen diğer etiketleri kontrol ediniz veya{" "}
