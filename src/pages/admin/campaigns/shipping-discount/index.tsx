...
import { CargoDiscount } from "@/constants/models/Discount";
...
function ShippingDiscountPage() {
  ...
  // Cast the discounts to ShippingDiscount[]
  const shippingDiscounts = discounts as CargoDiscount[];
  ...
  const handleCreate = () => {
    router.push("/admin/campaigns/shipping-discount/create");
  };

  const handleEdit = (id: string) => {
    router.push(`/admin/campaigns/shipping-discount/edit/${id}`);
  };
          ...
          <table className="table">
            ...
            <tbody className="table-border-bottom-0">
              {isLoading ? (
                ...
                <tr>
                  <td colSpan={7} className="text-center">
                    Henüz kargo indirimi bulunmuyor
                  </td>
                </tr>
              ) : (
                shippingDiscounts?.map((discount: CargoDiscount) => (
                  <tr key={discount.id}>
                    <td>
                    ...
                    <td>{discount.cargoDiscount?.minimumCargoAmount} ₺</td>
      ...
      >
        <div className="text-center">
          ...
          <p className="text-muted">
            Bu kargo indirimi silmek istediğinizden emin misiniz? Bu işlem geri
            alınamaz.
          </p>
        </div>
      </GeneralModal>
...
export default ShippingDiscountPage;
