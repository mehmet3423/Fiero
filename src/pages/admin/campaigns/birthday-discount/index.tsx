...
const BirthdayDiscountPage = () => {
  ...
  // Cast the discounts to BirthdayDiscount[]
  const birthdayDiscounts = discounts as BirthdayDiscount[];
  ...
  const handleCreate = () => {
    router.push("/admin/campaigns/birthday-discount/create");
  };

  const handleEdit = (id: string) => {
    router.push(`/admin/campaigns/birthday-discount/edit/${id}`);
  };
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      toast.success("Doğum günü indirimi başarıyla silindi");
    } catch (error) {
      toast.error("Doğum günü indirimi silinirken bir hata oluştu");
          ...
          <table className="table">
            ...
            <tbody className="table-border-bottom-0">
              {isLoading ? (
                ...
                <tr>
                  <td colSpan={7} className="text-center">
                    Henüz doğum günü indirimi bulunmuyor
                  </td>
                </tr>
              ) : (
                birthdayDiscounts?.map((discount: BirthdayDiscount) => (
                  <tr key={discount.id}>
                    <td>
                    ...
                    <td>
                      <small className="text-muted">
                        {discount.validDaysBefore} gün önce -{" "}
                        {discount.validDaysAfter} gün sonra
                      </small>
                    </td>
      ...
      >
        <div className="text-center">
          ...
          <p className="text-muted">
            Bu doğum günü indirimi silmek istediğinizden emin misiniz? Bu işlem
            geri alınamaz.
          </p>
        </div>
      </GeneralModal>
...
export default BirthdayDiscountPage;
