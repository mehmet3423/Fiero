...
const SpecialDayDiscountPage = () => {
  ...
  // Cast the discounts to SpecialDayDiscount[]
  const specialDayDiscounts = discounts as SpecialDayDiscount[];
  ...
  const handleCreate = () => {
    router.push("/admin/campaigns/special-day-discount/create");
  };

  const handleEdit = (id: string) => {
    router.push(`/admin/campaigns/special-day-discount/edit/${id}`);
  };
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      toast.success("Özel gün indirimi başarıyla silindi");
    } catch (error) {
      toast.error("Özel gün indirimi silinirken bir hata oluştu");
    }
  };
        ...
        <div className="table-responsive text-nowrap">
          <table className="table">
            ...
            <tbody className="table-border-bottom-0">
              ...
              ) : specialDayDiscounts?.length === 0 ? (
                <tr>
                  <td colSpan={7} className="text-center">
                    Henüz özel gün indirimi bulunmuyor
                  </td>
                </tr>
              ) : (
                specialDayDiscounts?.map((discount: SpecialDayDiscount) => (
                  <tr key={discount.id}>
                    <td>
                    ...
                    <td>
                      {discount.specialDayDiscount &&
                        `${discount.specialDayDiscount.day
                          .toString()
                          .padStart(2, "0")}.${discount.specialDayDiscount.month
                          .toString()
                          .padStart(2, "0")}.2025`}
                    </td>
      ...
      >
        <div className="text-center">
          ...
          <p className="text-muted">
            Bu özel gün indirimi silmek istediğinizden emin misiniz? Bu işlem
            geri alınamaz.
          </p>
        </div>
      </GeneralModal>
...
export default SpecialDayDiscountPage;
