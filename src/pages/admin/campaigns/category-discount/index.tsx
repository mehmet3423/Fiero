...
const SubCategoryDiscountPage = () => {
  ...
  const [isWithinActiveDateRange, setIsWithinActiveDateRange] = useState<
    boolean | undefined
  >(undefined);
  ...
  // Cast the discounts to SubCategoryDiscount[]
  const subCategoryDiscounts = discounts as SubCategoryDiscount[];
  ...
  const handleCreate = () => {
    router.push("/admin/campaigns/category-discount/create");
  };

  const handleEdit = (id: string) => {
    router.push(`/admin/campaigns/category-discount/edit/${id}`);
  };
...
export default SubCategoryDiscountPage;
