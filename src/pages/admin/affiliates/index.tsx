...
function AffiliatesPage() {
    ...
    return (
        <div className="page-content py-4 admin-compact-list">
            {/* İstatistik Kutuları */}
            <div className="card bg-transparent border-0 mb-3">
                <div className="card-body py-3 d-flex flex-column flex-md-row justify-content-between align-items-md-center">
                    <div>
                        <h4 className="mb-1 fw-bold">Affiliate Kullanıcıları</h4>
                        <p className="mb-0 text-muted" style={{ fontSize: "0.875rem" }}>
                            Affiliate kullanıcıları yönetin, ekleyin ve güncelleyin.
                        </p>
                    </div>
                </div>
            </div>
