...
import { getAffiliateStatusText, getUpdateableAffiliateStatusText, UpdateableAffiliateStatus } from "@/constants/enums/affiliate/AffiliateApplicationStatus";
...
function AffiliatesPage() {
    ...
    const { affiliateUserList, isLoading, error, totalCount } = useGetAffiliateUserList(pageIndex, pageSize);

    const { changeAffiliateUserStatus, isPending } = useChangeAffiliateUserStatus();
            ...
            <div className="card">
                ...
                <div className="card-body">
                    <div className="table-responsive">
                        <table className="table table-hover" style={{ fontSize: "0.813rem" }}>
                            <thead>
                                <tr>
                            ...
                            <>
                                <div className=" mb-4 border-0 shadow-sm">
                                    <div className="card-body p-4" style={{ fontSize: "1rem" }}>
                                        <h6 className="card-title mb-4 text-primary fw-semibold">Kullanıcı Bilgileri</h6>
                                            ...
                                            <div className="col-md-6">
                                                <div className="d-flex align-items-center mb-2">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span className="small">{editingUser.applicationUser.name}</span>
                                                    </div>
                                                </div>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span className="small">{editingUser.applicationUser.email}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-md-6">
                                                <div className="d-flex align-items-center mb-2">
                                                    ...
                                                    <div>
                                                        <small className="text-muted d-block">Mevcut Durum</small>
                                                        <span className="small">{getAffiliateStatusText(editingUser.status)}</span>
                                                    </div>
                                                </div>
                                                <div className="d-flex align-items-center">
                                                    <i className="fas fa-percentage me-2 text-muted"></i>
                                                    <div>
                                                        <small className="text-muted d-block">Mevcut Komisyon</small>
                                                        <span className="small">{editingUser.salesCommission || 0}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div className="form-group mb-3" style={{ fontSize: "1rem" }}>
                                    ...
                                    <div className="mb-2">
                                        <small className="text-muted">Mevcut Durum: {getAffiliateStatusText(editingUser.status)}</small>
                                    </div>
                                    <select
                                        style={{ fontSize: "0.8rem" }}
                                        className="form-select"
                                        value={Object.values(UpdateableAffiliateStatus).includes(editingUser.status) ? editForm.status : ''}
