import { useCreateSeo } from "@/hooks/services/admin-seo/useCreateSeo";
...
function CreateSeoPage() {
  ...
  const { createSeo, isPending } = useCreateSeo();
  ...
  // Autocomplete için inputun odak ve öneri kontrolü
  ...
  // Kullanıcı yazdıkça önerileri filtrele
  useEffect(() => {
  ...
  const handleInputChange = (
    ...
    if (field === "canonical" && typeof value === "string") {
      ...
      // Geçersiz karakter var mı kontrol et
      const invalidChars = invalidCanonicalChars(cleaned);
      if (invalidChars && !toast) {
        setToast({
          type: "error",
          message: `Canonical alanında geçersiz karakter(ler): ${invalidChars}. Sadece harf, rakam, tire, alt tire, slash ve nokta kullanabilirsiniz.`,
        });
      }
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="row">
                  ...
                  <div className="col-md-6">
                    ...
                    <div className="mb-3">
                      ...
                      <textarea
                        ...
                        placeholder="Meta description (maksimum 160 karakter)"
                        rows={3}
                        maxLength={160}
                      />
                    ...
                    {/* Canonical sadece genel sayfa için gösterilir */}
                    {seoType === "general" && (
                  ...
                  <div className="col-md-6">
                    ...
                    <div className="mb-3">
                      <label className="form-label">
                        Dil <span className="text-danger">*</span>
                      </label>
                      <select
                        className="form-select"
                      ...
                      <small className="text-muted">
                        Sadece Türkçe (tr) ve İngilizce (en) desteklenir
                      </small>
                    </div>
                ...
                <div className="d-flex gap-2 justify-content-end">
                  ...
                  <button
                    ...
                    disabled={isPending}
                  >
                    {isPending ? "Kaydediliyor..." : "SEO Kaydını Oluştur"}
                  </button>
                </div>
              </form>
            </div>
